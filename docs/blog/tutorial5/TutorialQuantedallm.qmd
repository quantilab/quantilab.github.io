...
<footer>
  <p>Copyright © 2025 by [Seraphine F. Maerz](https://seraphinem.github.io/). This page is built with ❤, [GitHub Copilot](https://github.com/features/copilot) and [Quarto](https://quarto.org/).</p>
</footer>
