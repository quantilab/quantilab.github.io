...
2.2.  Create an R project for your collaborative project with version control:
...
2.3. Set up your credentials for interacting with GitHub

In your RStudio Console, execute:
