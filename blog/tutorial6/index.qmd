...
description: "Introduction to the quallmer package for LLM-based qualitative coding in R - flexible codebooks, structured outputs, and transparent workflows."
...
::: {.text-center}
![quallmer package logo](quallmer_logo.png){width=220 fig-align="center" style="margin: 1.5rem auto;"}
:::
...
::: {.tutorial-nav}
::: {.prev}
[Previous Tutorial]{.nav-label}

[quanteda.llm for Text Analysis](../tutorial5/index.qmd){.nav-title}
:::
:::
