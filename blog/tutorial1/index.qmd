...
description: "Learn how to build and deploy your own personal website with Quarto and GitHub in less than 30 minutes - no previous experience required."
...
![Tutorial thumbnail showing a personal website example](thumbnail.png)
...
![GitHub interface showing the Create repository button](rep1.png){width=30%}
...
![RStudio New Project dialog](proj1.png){width=30%}
![Selecting qtwAcademic template in RStudio](proj2.png){width=30%}
...
![GitHub interface showing upload an existing file option](rep2.png){width=50%}
...
![GitHub Pages settings showing branch and folder configuration](rep3.png){width=50%}

::: {.tutorial-nav}
::: {.next}
[Next Tutorial]{.nav-label}

[GitHub for Collaborative Projects](../tutorial2/index.qmd){.nav-title}
:::
:::
