...
description: "Learn to create beautiful Quarto documents combining code, analysis, and narrative - output to PDF, Word, or HTML with ease."
...
![Tutorial thumbnail showing Quarto paper workflow](thumbnail.png)
...
![RStudio New Project dialog for creating a Quarto Project](projpaper.png){width="40%"}
...
![Example Quarto paper outputs in PDF and Word formats](examples.png)
