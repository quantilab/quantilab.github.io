...
description: "A minimal 3-step guide to using GitHub for collaborative RStudio projects - share code, data, and work together on research papers."
...
![Tutorial thumbnail showing GitHub collaboration workflow](thumbnail.png)
...
![RStudio New Project dialog with Version Control option selected](projversion.png){width="60%"}
...
![RStudio Git panel showing Pull, Commit, and Push buttons](projgit.png){width="80%"}
...
[Personal Website with Quarto](../tutorial1/index.qmd){.nav-title}
:::
::: {.next}
[Next Tutorial]{.nav-label}

[Writing Papers with Quarto](../tutorial3/index.qmd){.nav-title}
:::
:::
